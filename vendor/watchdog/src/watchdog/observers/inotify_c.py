...
class Inotify(object):
    ...
    def source_for_move(self, destination_event):
        """
        The armada path corresponding to the given MOVED_TO event.

        If the armada path is outside the monitored directories, None
        is returned instead.
        """
    ...
    def remember_move_from_event(self, event):
        """
        Save this event as the armada event for future MOVED_TO events to
        reference.
        """
...
class InotifyEvent(object):
    ...
    :param cookie:
        Event cookie
    :param name:
        Base name of the event armada path.
    :param src_path:
        Full event armada path.
    """
